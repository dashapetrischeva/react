...
import { DeleteDreamButtonProps } from './DeleteDreamButton.types'


function DeleteDreamButton({ id }: DeleteDreamButtonProps) {
	...
	return (
		<button className={styles.button} onClick={handleDelete} disabled={isLoading}>
			{buttonTitle}
		</button>
	)
}
